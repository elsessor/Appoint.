              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <h1 className="text-xl font-bold text-base-content truncate">{appointment.title || 'Appointment'}</h1>
              ...
              <div className="bg-base-100 border border-base-300 rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-base-200 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-base-content font-medium text-sm">{appointment.meetingType || 'Video Call'}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-base-200 rounded-lg">
                    <Clock className="w-10 h-10 text-primary flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-base-content font-medium text-sm">{appointment.duration || 30} minutes</p>
                    </div>
                  </div>
                </div>
                ...
                {appointment.title && (
                  <>
                    <div className="mb-6">
                      ...
                      <p className="text-base-content/70 text-sm">{appointment.title}</p>
                    </div>
                    <hr className="border-base-300 my-6" />
                  </>
                )}
                ...
                {appointment.description && (
                  <div>
                    ...
                    <p className="text-base-content/70 text-sm">{appointment.description}</p>
                  </div>
                )}
              </div>
